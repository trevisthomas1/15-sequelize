...
* [Burger 2: The Sequel](02-Homework/Instructions/homework_instructions.md)

### Key Activities

* [Simple Sequelize Demo](01-Activities/03-Chirpy-Sequelize)
* [Setting Up a Sequelize Project with the Sequelize CLI](01-Activities/06-SequelizeCLI)
* [Converting an ORM App to Use Sequelize](01-Activities/07-ORM-To-Sequelize)
* [Sequelize CREATE and READ](01-Activities/08-Sequelize-Create-Read)
* [Sequelize UPDATE and DELETE](01-Activities/09-Sequelize-Update-Delete)
* [One-to-One, One-to-Many Associations](01-Activities/13-Post-Author-Association)
* [Join Associated Models with Sequelize Queries](01-Activities/14-Post-Author-Joins)
